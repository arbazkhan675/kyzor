...
export default function EcommercePage() {
  ...
  return (
    <div className="space-y-16 lg:space-y-24 pb-16">
      {/* 1. Hero */}
      <section className="relative pt-12 pb-16 md:pt-20 md:pb-24 border-b border-slate-200/80 bg-gradient-to-b from-purple-50/30 via-white to-slate-50/50">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center space-y-6">
          <span className="inline-block text-xs font-mono uppercase tracking-widest text-purple-700 bg-purple-50 border border-purple-200/80 px-3 py-1 rounded-full font-semibold">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-10">
        <div className="text-center space-y-3">
          <h2 className="text-xs font-mono uppercase tracking-widest text-purple-700 font-semibold">Core System Capabilities</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {capabilities.map((cap) => {
            ...
            return (
              <div
                key={cap.title}
                className="group rounded-3xl border border-slate-200/90 bg-white p-6 space-y-4 shadow-xs hover:shadow-xl hover:-translate-y-1 hover:border-purple-300 transition-all duration-300"
              >
                ...
                <h3 className="text-lg font-bold text-slate-900 group-hover:text-purple-700 transition-colors">{cap.title}</h3>
      ...
      <section className="border-y border-slate-200/80 bg-slate-100/70 py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6 text-center">
          <h2 className="text-xs font-mono uppercase tracking-widest text-slate-600 font-semibold">Complete Deliverables</h2>
          <div className="flex flex-wrap items-center justify-center gap-3 max-w-4xl mx-auto">
            {deliverables.map((item) => (
              <span
                key={item}
                className="inline-flex items-center gap-2 rounded-xl bg-white border border-slate-200/90 px-4 py-2 text-xs font-semibold text-slate-800 shadow-xs"
              >
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-10">
        <div className="text-center space-y-3">
          <h2 className="text-xs font-mono uppercase tracking-widest text-purple-700 font-semibold">Optional Capabilities</h2>
          <p className="text-3xl font-extrabold text-slate-900 tracking-tight sm:text-4xl">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {optionalGrid.map((opt) => {
            ...
            return (
              <div
                key={opt.name}
                className="group rounded-2xl border border-slate-200/90 bg-white p-5 space-y-3 text-center flex flex-col items-center justify-center shadow-xs hover:shadow-md hover:-translate-y-1 hover:border-purple-300 transition-all duration-300"
              >
                <div className="w-9 h-9 rounded-xl bg-purple-50 flex items-center justify-center text-purple-700 group-hover:scale-110 transition-transform">
      ...
      <section className="border-t border-slate-200/80 bg-slate-100/60 py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center space-y-3">
            <h2 className="text-xs font-mono uppercase tracking-widest text-purple-700 font-semibold">Process</h2>
            <p className="text-3xl font-extrabold text-slate-900 tracking-tight sm:text-4xl">
