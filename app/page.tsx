    ...
    <div className="space-y-16 lg:space-y-24 pb-16">
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="text-center space-y-3">
          <h2 className="text-xs font-mono uppercase tracking-wider text-purple-400">Core Services</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-8 space-y-6 flex flex-col justify-between hover:border-purple-500/50 transition-colors duration-200">
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-xs text-zinc-400 pt-2 font-mono">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 text-purple-400" /> Tailored database architecture & schemas
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 text-purple-400" /> Sub-second load times & edge hosting
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 text-purple-400" /> Zero monthly platform plugin fees
                </li>
              </ul>
            </div>
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-8 space-y-6 flex flex-col justify-between hover:border-blue-500/50 transition-colors duration-200">
            <div className="space-y-4">
              <div className="w-12 h-12 rounded-xl bg-blue-500/10 border border-blue-500/30 flex items-center justify-center text-blue-400">
                <Cpu className="h-6 w-6" />
              </div>
              <h3 className="text-2xl font-bold text-white">Business Automations</h3>
              <p className="text-sm text-zinc-300 leading-relaxed">
              ...
              <ul className="space-y-2 text-xs text-zinc-400 pt-2 font-mono">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 text-blue-400" /> WhatsApp & Email auto-responses
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 text-blue-400" /> Autonomous AI agents & voice pipelines
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="h-4 w-4 text-blue-400" /> Custom CRM & operational webhooks
                </li>
              </ul>
            </div>
      ...
      {/* 3. Five-Step Process */}
      <section className="border-y border-zinc-800/80 bg-zinc-950/80 py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center space-y-3">
            <h2 className="text-xs font-mono uppercase tracking-wider text-purple-400">Methodology</h2>
            <p className="text-3xl font-extrabold text-white tracking-tight sm:text-4xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {processSteps.map((step) => (
              <div
                key={step.number}
                className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-6 space-y-3 flex flex-col justify-between"
              >
                <div className="space-y-2">
                  <span className="text-2xl font-mono font-extrabold text-purple-400">{step.number}</span>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div>
            <h2 className="text-xs font-mono uppercase tracking-wider text-purple-400">Selected Work</h2>
            <p className="text-3xl font-extrabold text-white tracking-tight sm:text-4xl">
        ...
        {featuredWork.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {featuredWork.map((item) => (
              <div
                key={item.id}
                className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-6 space-y-4 flex flex-col justify-between hover:border-zinc-700 transition-colors"
              >
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-mono uppercase text-purple-400 bg-purple-500/10 px-2.5 py-0.5 rounded">
                      {item.category}
                    </span>
                    {item.is_demo && (
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-8 text-center space-y-3">
            <Sparkles className="mx-auto h-8 w-8 text-purple-400 opacity-80" />
            <h3 className="text-lg font-semibold text-white">Custom Engineering Portfolio</h3>
      ...
      <section className="border-t border-zinc-800/80 bg-zinc-950 py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center space-y-3">
            <h2 className="text-xs font-mono uppercase tracking-wider text-purple-400">Why Kyzor</h2>
            <p className="text-3xl font-extrabold text-white tracking-tight sm:text-4xl">
