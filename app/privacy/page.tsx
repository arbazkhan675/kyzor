      ...
      <div className="space-y-8 text-sm text-slate-700 leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-6 space-y-1.5 text-slate-600">
            ...
            <li><strong className="text-slate-900">Project Requirements:</strong> Selected project type (custom e-commerce application, business automation, or integrated system), estimated budget range, and detailed project overview message.</li>
            <li><strong className="text-slate-900">Technical Metadata:</strong> IP address and submission timestamp for security logging and rate-limiting enforcement.</li>
          </ul>
        </section>
        ...
        {/* Section 3 */}
        <section className="space-y-3">
          <h2 className="text-xl font-bold text-slate-900">3. Data Processors & Infrastructure</h2>
          <p>
          ...
          <ul className="list-disc pl-6 space-y-1.5 text-slate-600">
            <li><strong className="text-slate-900">Database & Authentication:</strong> Supabase (PostgreSQL database with Row Level Security enabled).</li>
            <li><strong className="text-slate-900">Transactional Email:</strong> Resend API for notification dispatching.</li>
            <li><strong className="text-slate-900">Hosting Infrastructure:</strong> Vercel edge deployment network.</li>
          </ul>
        ...
        {/* Section 4 */}
        <section className="space-y-3">
          <h2 className="text-xl font-bold text-slate-900">4. Data Retention</h2>
          <p>
        ...
        {/* Section 5 */}
        <section className="space-y-3">
          <h2 className="text-xl font-bold text-slate-900">5. Your Rights & Contact Information</h2>
          <p>
